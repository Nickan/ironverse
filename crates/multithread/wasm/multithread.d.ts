...
declare interface InitOutput {
  ...
  readonly numbereval_get_voxel: (a: number, b: number) => void;
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h2dff3c88cb1928b1: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h058c18c65905c7c8: (a: number, b: number, c: number) => void;
